                    ...
                    <div className="flex flex-row items-center justify-between">
                        <div className=" max-w-[400px]">
                            ...
                            <p className="leading-6 mb-8">I’m a self-taught front-end developer based in Kyiv, Ukraine.
                                I
                                can develop responsive websites from scratch and raise them into modern user-friendly
                                web
                                experiences.</p>
                            <p className="leading-6 mb-8">Transforming my creativity and knowledge into a websites has
                                been
                                my passion for over a year. I have been helping various clients to establish their
                                presence
                                online. I always strive to learn about the newest technologies and frameworks.</p>
                            <button className="btn-primary font-medium py-2 px-4"><Link
                                to={"/about"}>{"Read more ->"}</Link></button>
                        </div>
