import dude from '../assets/me.png'
import outlineLogo from '../assets/outlineLogo.svg'
import {Dots} from "./Dots.tsx";
const Portrait = () => {
    return (
        <div className="relative ">
            <img className="relative z-20  mx-auto w-11/12" alt="humanoid" src={dude}/>
            ...
            <div className="absolute right-[5%] bottom-1/4 z-20">
                ...
                <div
                    className="curr-working w-[95%] relative left-[10px] flex flex-row items-center border border-gray p-2">
