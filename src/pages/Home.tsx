    ...
    return (
        <div className="flex flex-col gap-20 max-w-2xl lg:max-w-7xl -z-20 mx-auto">
            ...
            <div className="max-sm:hidden flex flex-col gap-20 ">
                <div>
                    <div className=" hidden lg:block absolute left-0 translate-y-full translate-x-3"><Dots rows={5} columns={2}/> </div>
                ...
                <div>
                    ...
                    <div className=" hidden lg:block absolute right-0 translate-y-[550%]"><Dots rows={5} columns={4}/></div>
                    <AnimateOnScroll variant="right">
                        <AboutMeSection/>
                    </AnimateOnScroll>
                </div>
                <div>
                    <div className="hidden lg:block absolute left-0 translate-y-[110%]"><Dots rows={5} columns={3}/> </div>
                    <AnimateOnScroll variant="left">
                        <ContactsSection/>
                    </AnimateOnScroll>
                </div>
